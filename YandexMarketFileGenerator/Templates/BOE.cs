...
{
    [Description("Шаблон для BOE")]
    public class BOEYandexDirectTemplate : IYandexDirectTemplate
    {
        public string Manufacturer { get; } = "BOE";
        ...
        public Dictionary<string, string> ColumnStaticValues { get; } = new Dictionary<string, string>()
        {
            ...
            ["X"] = "Активно",
            ["Y"] = "Работает везде",
            ["Z"] = "Стандартные дисплеи||Модули||Квадратные и круглые матрицы||OLED экраны||Для видеостен",
            ["AA"] = "",
            ["AB"] = "https://etk-komplekt.ru/promyshlennoe-oborudovanie-i-kip/displei/tft-lcd-paneli/standartnye-tft-lcd-paneli/standartnye-tft-lcd-paneli-boe/?utm_source=yandex&roistat=direct1_{source_type}_{banner_id}_{keyword}&roistat_referrer={source}&roistat_pos={position_type}_{position}||https://etk-komplekt.ru/promyshlennoe-oborudovanie-i-kip/displei/tft-moduli/tft-lcd-moduli-boe/?utm_source=yandex&roistat=direct1_{source_type}_{banner_id}_{keyword}&roistat_referrer={source}&roistat_pos={position_type}_{position}||https://etk-komplekt.ru/promyshlennoe-oborudovanie-i-kip/displei/tft-lcd-paneli/vytyanutye-kvadratnye-kruglye-tft-lcd-paneli/vytyanutye-kvadratnye-kruglye-tft-lcd-paneli-boe/?utm_source=yandex&roistat=direct1_{source_type}_{banner_id}_{keyword}&roistat_referrer={source}&roistat_pos={position_type}_{position}||https://etk-komplekt.ru/promyshlennoe-oborudovanie-i-kip/displei/tft-moduli/epaper-oled-amoled-boe/?utm_source=yandex&roistat=direct1_{source_type}_{banner_id}_{keyword}&roistat_referrer={source}&roistat_pos={position_type}_{position}||https://etk-komplekt.ru/promyshlennoe-oborudovanie-i-kip/displei/tft-lcd-paneli/tft-lcd-paneli-dlya-videosten/tft-lcd-paneli-dlya-videosten-boe/?utm_source=yandex&roistat=direct1_{source_type}_{banner_id}_{keyword}&roistat_referrer={source}&roistat_pos={position_type}_{position}",
        ...
        {
            var data = new YandexMarketSection(this, typeof(BOEYandexMarketSectionLine), productInfo, groupIndex);

            return data.BuildSection(linesCount);
        }
    }

    internal class BOEYandexMarketSectionLine : YandexMarketSectionLineBase
    {

        public BOEYandexMarketSectionLine(YandexMarketSection parentSection) : base(parentSection)
        {
